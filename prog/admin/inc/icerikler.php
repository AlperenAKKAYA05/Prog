...
<div class="row"><div class="col-lg-12"><h1 class="page-header"><i class="fa fa-file"></i> İçerikler <a href="<?php echo URL."/admin/index.php?do=icerik-ekle"; ?>" class="linkSag"><i class="fa fa-file-text"></i> Yeni İçerik Ekle</a></h1></div></div>
<?php
...
<i class="fa fa-warning"></i><strong> Henüz hiç içerik eklenmemiş.</strong>
</div>
<?php } ?>